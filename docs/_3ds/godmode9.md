...
<li>Extract <code>/GodMode9.firm</code> from the zip to <code>/luma/payloads/GodMode9.firm</code> on your SD card</li>
<li>Extract <code>/gm9</code> from the zip to <code>/gm9</code> on your SD card</li>
</ol>
</details>
